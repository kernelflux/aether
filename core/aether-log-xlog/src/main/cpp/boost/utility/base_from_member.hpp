...
{
    typedef typename ::aether_boost::remove_cv<typename
     ::aether_boost::remove_reference<T>::type>::type  type;

};  // aether_boost::detail::remove_cv_ref
...
struct is_related
    : public ::aether_boost::is_same<
     typename ::aether_boost::detail::remove_cv_ref<T>::type,
     typename ::aether_boost::detail::remove_cv_ref<U>::type >
{};
...
struct enable_if_unrelated
    : public ::aether_boost::enable_if_c<true>
{};

template<typename T, typename U, typename ...U2>
struct enable_if_unrelated<T, U, U2...>
    : public ::aether_boost::disable_if< ::aether_boost::detail::is_related<T, U> >
{};
#endif
...
protected:
    ...
    template <typename ...T, typename EnableIf = typename
     ::aether_boost::detail::enable_if_unrelated<base_from_member, T...>::type>
