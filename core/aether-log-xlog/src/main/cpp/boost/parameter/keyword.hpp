...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost { namespace parameter {
...
#define BOOST_PARAMETER_KEYWORD(tag_namespace,name)                 \
    ...
    namespace                                                       \
    {                                                               \
       ::aether_boost::parameter::keyword<tag_namespace::name> const& name \
       = ::aether_boost::parameter::keyword<tag_namespace::name>::instance;\
    }

}} // namespace aether_boost::parameter
