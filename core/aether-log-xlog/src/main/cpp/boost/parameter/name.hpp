...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost { namespace mpl {
...
# define BOOST_PARAMETER_BASIC_NAME(tag_namespace, tag, name)       \
      ...
      {                                                             \
          ...
          {                                                         \
              return BOOST_PP_STRINGIZE(tag);                       \
                                                                    ...
                                                                    \
          typedef aether_boost::parameter::value_type<                     \
              aether_boost::mpl::_2, tag, aether_boost::parameter::void_          \
          > _;                                                      \
                                                                    \
          typedef aether_boost::parameter::value_type<                     \
              aether_boost::mpl::_2, tag, aether_boost::parameter::void_          \
    ...
    namespace                                                       \
    {                                                               \
       ::aether_boost::parameter::keyword<tag_namespace::tag> const& name  \
       = ::aether_boost::parameter::keyword<tag_namespace::tag>::instance; \
    }
...
# define BOOST_PARAMETER_TEMPLATE_KEYWORD(name)                     \
    ...
    template <class T>                                              \
    struct name                                                     \
      : aether_boost::parameter::template_keyword<tag::name, T>            \
    {};                                                             \
/**/
