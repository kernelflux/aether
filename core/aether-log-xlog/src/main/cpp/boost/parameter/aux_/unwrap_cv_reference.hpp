...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost { template<class T> class reference_wrapper; }
...
// Can't use aether_boost::unwrap_reference<> here because it
