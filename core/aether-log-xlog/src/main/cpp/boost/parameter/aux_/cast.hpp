...
struct cast<void(T), Args>
{
    ...
    typedef typename aether_boost::add_reference<
        typename aether_boost::remove_const<type0>::type 
    >::type reference;
...
#  define BOOST_PARAMETER_FUNCTION_CAST(value, predicate, args) \
    aether_boost::parameter::aux::cast<void predicate, args>::remove_const( \
        aether_boost::parameter::aux::cast<void predicate, args>::execute(value) \
    )
