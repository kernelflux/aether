...
//! \file
//!   This header forward declares aether_boost::container::constructible_with_allocator_prefix,
//!   aether_boost::container::constructible_with_allocator_suffix and
//!   aether_boost::container::uses_allocator. Also defines the following types:
