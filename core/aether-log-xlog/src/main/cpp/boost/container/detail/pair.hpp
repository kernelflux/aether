...
struct pair
{
   ...
   pair(BOOST_RV_REF(pair) p)
      : first(::aether_boost::move(p.first)), second(::aether_boost::move(p.second))
   {}
   ...
   pair(BOOST_FWD_REF(U) u, BOOST_FWD_REF(V) v)
      : first(::aether_boost::forward<U>(u))
      , second(::aether_boost::forward<V>(v))
   {}
   ...
   {
      first  = ::aether_boost::move(p.first);
      second = ::aether_boost::move(p.second);
      return *this;
   }

   template <class D, class S>
   typename ::aether_boost::container::container_detail::disable_if_or
      < pair &
      , ::aether_boost::container::container_detail::is_same<T1, D>
      , ::aether_boost::container::container_detail::is_same<T2, S>
      >::type
...
//std::pair copy assignment
   ...
   void swap(pair& p)
   {
      ::aether_boost::adl_move_swap(this->first, p.first);
      ::aether_boost::adl_move_swap(this->second, p.second);
   }
};
...
struct is_enum< ::aether_boost::container::container_detail::pair<T, U> >
{
   static const bool value = false;
};
...
template <class T1, class T2>
struct is_class< ::aether_boost::container::container_detail::pair<T1, T2> >
{
   static const bool value = true;
};
...
template<class T1, class T2>
struct has_move_emulation_enabled< ::aether_boost::container::container_detail::pair<T1, T2> >
{
   static const bool value = true;
};
...
template <class T1, class T2>
struct is_class_or_union< ::aether_boost::container::container_detail::pair<T1, T2> >
//This specialization is needed to avoid instantiation of pair in
//is_class, and allow recursive maps.
{
   static const bool value = true;
