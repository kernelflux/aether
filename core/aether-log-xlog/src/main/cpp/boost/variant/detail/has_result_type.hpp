...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost { namespace detail { namespace variant {
...
private:
    ...
    template<typename C> static yes test(typename aether_boost::remove_reference<typename C::result_type>::type*);
...
}}} // namespace aether_boost::detail::variant
