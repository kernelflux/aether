...
template <typename R = ::aether_boost::detail::static_visitor_default_return>
...
struct is_static_visitor_impl
{
    BOOST_STATIC_CONSTANT(bool, value = 
        (::aether_boost::is_base_and_derived< 
...
template< typename T > struct is_static_visitor
	: public ::aether_boost::integral_constant<bool,(::aether_boost::detail::is_static_visitor_impl<T>::value)>
{
public:
