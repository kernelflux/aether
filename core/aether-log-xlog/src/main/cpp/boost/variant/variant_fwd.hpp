...
//
// Exposes a aether_boost::variant with recursive_variant_ tags (below) substituted
// with the variant itself (wrapped as needed with aether_boost::recursive_wrapper).
//
