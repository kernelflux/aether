...
{
    typedef aether_boost::uint8_t type;
...
{
    typedef aether_boost::int8_t type;
...
{
    typedef aether_boost::uint16_t type;
...
{
    typedef aether_boost::int16_t type;
...
{
    typedef aether_boost::uint32_t type;
...
{
    typedef aether_boost::int32_t type;
...
{
    typedef aether_boost::uint64_t type;
...
{
    typedef aether_boost::int64_t type;
...
{
    typedef aether_boost::uint128_type type;
...
{
    typedef aether_boost::int128_type type;
