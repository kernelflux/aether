...
#pragma warning(push)
// 'aether_boost::atomics::atomic<T>' : multiple assignment operators specified
...
template< typename T, bool IsInt = aether_boost::is_integral< T >::value >
struct classify
{
    typedef void type;
};
...
private:
    ...
    typedef atomics::detail::operations< storage_size_of< value_type >::value, aether_boost::is_signed< T >::value > operations;
...
typedef atomic< aether_boost::ulong_long_type > atomic_ullong;
typedef atomic< aether_boost::long_long_type > atomic_llong;
#endif
