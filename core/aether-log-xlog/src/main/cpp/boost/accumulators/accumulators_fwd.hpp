...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost { namespace accumulators
{
...
#define BOOST_ACCUMULATORS_IGNORE_GLOBAL(X)                             \
    ...
    {                                                                   \
        ...
        {                                                               \
            void ignore()                                               \
            {                                                           \
                aether_boost::accumulators::detail::ignore_variable(&X);       \
            }                                                           \
        };                                                              \
    }                                                                   \
    /**/
...
}} // namespace aether_boost::accumulators

// For defining aether_boost::parameter keywords that can be inherited from to
...
#define BOOST_PARAMETER_NESTED_KEYWORD(tag_namespace, name, alias)                                  \
    ...
    {                                                                                               \
        ...
        {                                                                                           \
            ...
            static ::aether_boost::parameter::keyword<name ## _<Dummy> > &alias;                           \
        };                                                                                          \
        template<int Dummy>                                                                         \
        ::aether_boost::parameter::keyword<name ## _<Dummy> > &name ## _<Dummy>::alias =                   \
        ::aether_boost::parameter::keyword<name ## _<Dummy> >::get();                                      \
        typedef name ## _ <> name;                                                                  \
    }                                                                                               \
    namespace                                                                                       \
    {                                                                                               \
        ::aether_boost::parameter::keyword<tag_namespace::name> &name =                                    \
        ::aether_boost::parameter::keyword<tag_namespace::name>::get();                                    \
    }
