...
#define BOOST_NUMERIC_FUNCTIONAL_DEFINE_UNARY_OP(Name, Op)                                      \
    ...
    {                                                                                           \
        ...
        {                                                                                       \
            BOOST_TYPEOF_NESTED_TYPEDEF_TPL(                                                    \
                nested                                                                          \
              , Op aether_boost::numeric::functional::detail::lvalue_of<Arg>()                         \
            )                                                                                   \
    ...
    {                                                                                           \
        struct Name                                                                             \
          : aether_boost::detail::function1<functional::Name<_, functional::tag<_> > >                 \
        {};                                                                                     \
    }                                                                                           \
    namespace                                                                                   \
    {                                                                                           \
        op::Name const &Name = aether_boost::detail::pod_singleton<op::Name>::instance;                \
    }                                                                                           \
    /**/
...
#define BOOST_NUMERIC_FUNCTIONAL_DEDUCED(Left, Op, Right)                                       \
    BOOST_TYPEOF_NESTED_TYPEDEF_TPL(                                                            \
        nested                                                                                  \
      , aether_boost::numeric::functional::detail::lvalue_of<Left>() Op                                \
        aether_boost::numeric::functional::detail::lvalue_of<Right>()                                  \
    )                                                                                           \
    typedef typename nested::type type;                                                         \
    /**/
...
#undef BOOST_NUMERIC_FUNCTIONAL_DEFINE_BINARY_OP
    ...
    namespace op
    {
        ...
        struct promote
          : aether_boost::detail::function1<functional::promote<To, _, typename functional::tag<To>::type, functional::tag<_> > >
        {};

        struct min_assign
          : aether_boost::detail::function2<functional::min_assign<_1, _2, functional::tag<_1>, functional::tag<_2> > >
        {};

        struct max_assign
          : aether_boost::detail::function2<functional::max_assign<_1, _2, functional::tag<_1>, functional::tag<_2> > >
        {};

        struct fdiv
          : aether_boost::detail::function2<functional::fdiv<_1, _2, functional::tag<_1>, functional::tag<_2> > >
        {};
        ...
        struct as_min
          : aether_boost::detail::function1<functional::as_min<_, functional::tag<_> > >
        {};

        struct as_max
          : aether_boost::detail::function1<functional::as_max<_, functional::tag<_> > >
        {};

        struct as_zero
          : aether_boost::detail::function1<functional::as_zero<_, functional::tag<_> > >
        {};

        struct as_one
          : aether_boost::detail::function1<functional::as_one<_, functional::tag<_> > >
        {};
    }

    namespace
    {
        op::min_assign const &min_assign = aether_boost::detail::pod_singleton<op::min_assign>::instance;
        op::max_assign const &max_assign = aether_boost::detail::pod_singleton<op::max_assign>::instance;
        op::fdiv const &fdiv = aether_boost::detail::pod_singleton<op::fdiv>::instance;
        op::fdiv const &average = aether_boost::detail::pod_singleton<op::fdiv>::instance; ///< INTERNAL ONLY
        op::as_min const &as_min = aether_boost::detail::pod_singleton<op::as_min>::instance;
        op::as_max const &as_max = aether_boost::detail::pod_singleton<op::as_max>::instance;
        op::as_zero const &as_zero = aether_boost::detail::pod_singleton<op::as_zero>::instance;
        op::as_one const &as_one = aether_boost::detail::pod_singleton<op::as_one>::instance;
...
}} // namespace aether_boost::numeric
