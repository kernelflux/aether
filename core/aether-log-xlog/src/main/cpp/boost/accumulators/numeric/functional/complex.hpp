...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost { namespace numeric { namespace operators
{
...
}}} // namespace aether_boost::numeric::operators
