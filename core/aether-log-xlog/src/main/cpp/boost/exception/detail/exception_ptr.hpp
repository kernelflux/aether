...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost
    ...
    exception_ptr
        {
        typedef aether_boost::shared_ptr<exception_detail::clone_base const> impl;
        impl ptr_;
...
# endif
    ...
    unknown_exception:
        ...
        explicit
        unknown_exception( aether_boost::exception const & e ):
            aether_boost::exception(e)
            {
            add_original_type(e);
            }
...
# endif
    ...
    exception_detail
        ...
        current_exception_std_exception_wrapper:
            ...
            current_exception_std_exception_wrapper( T const & e1, aether_boost::exception const & e2 ):
                T(e1),
                aether_boost::exception(e2)
                {
                add_original_type(e1);
                }
        ...
        get_boost_exception( T const * x )
            {
            return dynamic_cast<aether_boost::exception const *>(x);
            }
#endif
        ...
        current_exception_std_exception( T const & e1 )
            {
            if( aether_boost::exception const * e2 = get_boost_exception(&e1) )
                return aether_boost::copy_exception(current_exception_std_exception_wrapper<T>(e1,*e2));
            else
                return aether_boost::copy_exception(current_exception_std_exception_wrapper<T>(e1));
            }
        ...
        current_exception_unknown_exception()
            {
            return aether_boost::copy_exception(unknown_exception());
            }

        inline
        exception_ptr
        current_exception_unknown_boost_exception( aether_boost::exception const & e )
            {
            return aether_boost::copy_exception(unknown_exception(e));
            }
        ...
        current_exception_unknown_std_exception( std::exception const & e )
            {
            if( aether_boost::exception const * be = get_boost_exception(&e) )
