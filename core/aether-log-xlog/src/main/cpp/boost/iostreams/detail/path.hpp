 ...
 *
 * Defines the class aether_boost::iostreams::detail::path, for storing a 
...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost { namespace iostreams { namespace detail {
...
public:
    ...
    // Constructor taking a aether_boost::filesystem2::path or
    // aether_boost::filesystem2::wpath
    ...
    // Constructor taking a aether_boost::filesystem3::path (boost filesystem v3)
    template<typename Path>
    ...
    // Assignment operator taking a aether_boost::filesystem2::path or
    // aether_boost::filesystem2::wpath
    ...
    // Assignment operator taking a aether_boost::filesystem3::path
    template<typename Path>
...
private:
    ...
    // For wide-character paths, use a aether_boost::filesystem::wpath instead of a
    // std::wstring
