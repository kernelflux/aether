...
//
//    using namespace aether_boost::utility;
//
//    case_<0> helper(bool);
//    case_<1> helper(int);
...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost { namespace utility {
...
#define BOOST_SELECT_BY_SIZE(type_, name, expr) \
    ...
    BOOST_STATIC_CONSTANT( \
        type_, \
        name = \
            ( ::aether_boost::iostreams::detail::select_by_size< \
