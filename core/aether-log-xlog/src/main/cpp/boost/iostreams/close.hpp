...
{ 
    BOOST_TRY {
        aether_boost::iostreams::close(t, BOOST_IOS::in);
    } BOOST_CATCH (...) {
        BOOST_TRY {
            aether_boost::iostreams::close(t, BOOST_IOS::out);
...
{
    BOOST_TRY {
        aether_boost::iostreams::close(t, snk, BOOST_IOS::in);
    } BOOST_CATCH (...) {
        BOOST_TRY {
            aether_boost::iostreams::close(t, snk, BOOST_IOS::out);
        } BOOST_CATCH (...) { } BOOST_CATCH_END
        BOOST_RETHROW;
    } BOOST_CATCH_END
    aether_boost::iostreams::close(t, snk, BOOST_IOS::out);
