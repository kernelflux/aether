...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost { namespace mpl { namespace aux {
...
template< typename T, typename name = ::aether_boost::mpl::aux::has_xxx_tag > \
struct BOOST_PP_CAT(trait,_impl) : T \
{ \
    static aether_boost::mpl::aux::no_tag \
    test(void(*)(::aether_boost::mpl::aux::has_xxx_tag)); \
    \
    static aether_boost::mpl::aux::yes_tag test(...); \
    \
    BOOST_STATIC_CONSTANT(bool, value = \
          sizeof(test(static_cast<void(*)(name)>(0))) \
            != sizeof(aether_boost::mpl::aux::no_tag) \
        ); \
    typedef aether_boost::mpl::bool_<value> type; \
}; \
\
template< typename T, typename fallback_ = aether_boost::mpl::bool_<default_> > \
struct trait \
    : aether_boost::mpl::if_c< \
          aether_boost::mpl::aux::msvc_is_incomplete<T>::value \
        , aether_boost::mpl::bool_<false> \
...
{ \
    BOOST_STATIC_CONSTANT(bool, value = false); \
    typedef aether_boost::mpl::bool_<false> type; \
}; \
/**/
...
{ \
    ...
    { \
        template < class U > \
        static int  resolve( aether_boost::mpl::aux::type_wrapper<U> const volatile * \
                           , aether_boost::mpl::aux::type_wrapper<typename U::name >* = 0 ); \
        static char resolve( ... ); \
    }; \
    typedef aether_boost::mpl::aux::type_wrapper<T> t_; \
    BOOST_STATIC_CONSTANT( bool, value = ( sizeof( trait_tester_impl::resolve( static_cast< t_ * >(0) ) ) == sizeof(int) ) ); \
}; \
template< typename T, typename fallback_ = aether_boost::mpl::bool_<default_> > \
struct trait           \
{                      \
    BOOST_STATIC_CONSTANT( bool, value = (trait_tester< T, aether_boost::is_class< T >::value >::value) );     \
    typedef aether_boost::mpl::bool_< trait< T, fallback_ >::value > type; \
};
...
{ \
    ...
    { \
        template< typename U > \
        static aether_boost::mpl::aux::yes_tag test( \
              aether_boost::mpl::aux::type_wrapper<U> const volatile* \
            , aether_boost::mpl::aux::type_wrapper<BOOST_MSVC_TYPENAME U::name>* = 0 \
            ); \
    \
        static aether_boost::mpl::aux::no_tag test(...); \
    }; \
    \
    typedef aether_boost::mpl::aux::type_wrapper<T> t_; \
    BOOST_STATIC_CONSTANT(bool, value = \
          sizeof(gcc_3_2_wknd::test(static_cast<t_*>(0))) \
            == sizeof(aether_boost::mpl::aux::yes_tag) \
        ); \
    typedef aether_boost::mpl::bool_<value> type; \
}; \
/**/
...
#     define BOOST_MPL_HAS_MEMBER_MULTI_ACCEPT(z, n, args) \
        template< typename V > \
        static aether_boost::mpl::aux::yes_tag \
        BOOST_MPL_HAS_MEMBER_INTROSPECTION_TEST_NAME(args)( \
            aether_boost::mpl::aux::type_wrapper< V > const volatile* \
...
#       define BOOST_MPL_HAS_MEMBER_TEST(args) \
          sizeof( \
              BOOST_MPL_HAS_MEMBER_INTROSPECTION_TEST_NAME(args)( \
                  static_cast< aether_boost::mpl::aux::type_wrapper< U >* >(0) \
              ) \
          ) == sizeof(aether_boost::mpl::aux::yes_tag) \
        /**/
#     else
...
#   define BOOST_MPL_HAS_MEMBER_IMPLEMENTATION( \
      ...
      template< \
          typename T \
        , typename fallback_ \
              = aether_boost::mpl::bool_< BOOST_PP_ARRAY_ELEM(3, args) > \
      > \
...
#   define BOOST_MPL_HAS_XXX_TEMPLATE_NAMED_DEF(trait, name, default_) \
      template< typename T \
              , typename fallback_ = aether_boost::mpl::bool_< default_ > > \
      struct trait { \
          BOOST_STATIC_CONSTANT(bool, value = fallback_::value); \
          typedef fallback_ type; \
      }; \
