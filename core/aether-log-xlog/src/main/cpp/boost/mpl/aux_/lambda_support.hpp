...
template< BOOST_MPL_PP_PARAMS(i,typename T) > \
::aether_boost::mpl::aux::yes_tag operator|( \
      ::aether_boost::mpl::aux::has_rebind_tag<int> \
    , name<BOOST_MPL_PP_PARAMS(i,T)>* \
    ); \
::aether_boost::mpl::aux::no_tag operator|( \
      ::aether_boost::mpl::aux::has_rebind_tag<int> \
    , name< BOOST_MPL_PP_ENUM(i,::aether_boost::mpl::na) >* \
    ); \
/**/
...
::aether_boost::mpl::aux::yes_tag operator|( \
      ::aether_boost::mpl::aux::has_rebind_tag<int> \
    , ::aether_boost::mpl::aux::has_rebind_tag< name<BOOST_MPL_PP_PARAMS(i,T)> >* \
    ); \
/**/
#else
#   define BOOST_MPL_AUX_LAMBDA_SUPPORT_HAS_REBIND(i, name, params) /**/
