    ...
    public:
      ...
      template <class ErrorConditionEnum>
        error_condition(ErrorConditionEnum e,
          typename aether_boost::enable_if<is_error_condition_enum<ErrorConditionEnum> >::type* = 0) BOOST_SYSTEM_NOEXCEPT
      {
      ...
      template<typename ErrorConditionEnum>
        typename aether_boost::enable_if<is_error_condition_enum<ErrorConditionEnum>, error_condition>::type &
    ...
    public:
      ...
      template <class ErrorCodeEnum>
        error_code(ErrorCodeEnum e,
          typename aether_boost::enable_if<is_error_code_enum<ErrorCodeEnum> >::type* = 0) BOOST_SYSTEM_NOEXCEPT
      {
      ...
      template<typename ErrorCodeEnum>
        typename aether_boost::enable_if<is_error_code_enum<ErrorCodeEnum>, error_code>::type &
...
# endif
    ...
    //  "throws" function in namespace aether_boost rather than namespace aether_boost::system.
