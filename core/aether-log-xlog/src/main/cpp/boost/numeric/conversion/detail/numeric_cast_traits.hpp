...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost { namespace numeric {
    ...
    #define BOOST_NUMERIC_CONVERSION_SEQ_A() BOOST_NUMERIC_CONVERSION_BASE_BUILTIN_TYPES()(aether_boost::long_long_type)(aether_boost::ulong_long_type)
	#define BOOST_NUMERIC_CONVERSION_SEQ_B() (aether_boost::long_long_type)(aether_boost::ulong_long_type)
