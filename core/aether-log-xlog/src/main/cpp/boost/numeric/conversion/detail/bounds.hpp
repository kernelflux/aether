...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost { namespace numeric { namespace boundsdetail
{
  template<class N>
  class Integral
  {
...
} } } // namespace aether_boost::numeric::boundsdetail.
