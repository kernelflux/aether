...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost { namespace numeric { namespace convdetail
{
...
} } } // namespace aether_boost::numeric::convdetail
