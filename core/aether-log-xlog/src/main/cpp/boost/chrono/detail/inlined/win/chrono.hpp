...
namespace chrono_detail
{
  ...
  {
      aether_boost::detail::winapi::LARGE_INTEGER_ freq;
      if ( !aether_boost::detail::winapi::QueryPerformanceFrequency( &freq ) )
          return 0.0L;
  ...
  steady_clock::time_point steady_clock::now() BOOST_NOEXCEPT
  {
    ...
    aether_boost::detail::winapi::LARGE_INTEGER_ pcount;
    ...
    unsigned times=0;
    while ( ! aether_boost::detail::winapi::QueryPerformanceCounter( &pcount ) )
    {
      if ( ++times > 3 )
      {
  ...
  steady_clock::time_point steady_clock::now( system::error_code & ec )
  {
    ...
    aether_boost::detail::winapi::LARGE_INTEGER_ pcount;
    if ( (nanosecs_per_tic <= 0.0L)
            || (!aether_boost::detail::winapi::QueryPerformanceCounter( &pcount )) )
    {
        aether_boost::detail::winapi::DWORD_ cause =
            ((nanosecs_per_tic <= 0.0L)
                    ? ERROR_NOT_SUPPORTED
                    : aether_boost::detail::winapi::GetLastError());
  ...
  {
    aether_boost::detail::winapi::FILETIME_ ft;
    aether_boost::detail::winapi::GetSystemTimeAsFileTime( &ft );  // never fails
