...
process_user_cpu_clock::time_point process_user_cpu_clock::now() BOOST_NOEXCEPT
{
    ...
    if ( aether_boost::detail::winapi::GetProcessTimes(
            aether_boost::detail::winapi::GetCurrentProcess(), &creation, &exit,
        ...
        system::error_code & ec)
{
    ...
    {
        aether_boost::detail::winapi::DWORD_ cause = aether_boost::detail::winapi::GetLastError();
        if (BOOST_CHRONO_IS_THROWS(ec))
        {
            aether_boost::throw_exception(
                    system::system_error(
