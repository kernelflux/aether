...
{
   BOOST_STATIC_CONSTANT(bool, value = (::aether_boost::detail::is_unsigned_values<T>::minus_one > ::aether_boost::detail::is_unsigned_values<T>::zero));
};
...
struct is_unsigned
{
   typedef ::aether_boost::detail::is_unsigned_select_helper< ::aether_boost::is_integral<T>::value || ::aether_boost::is_enum<T>::value > selector;
...
template <class T> struct is_unsigned : public integral_constant<bool, aether_boost::detail::is_unsigned<T>::value> {};
...
template <> struct is_unsigned< ::aether_boost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<const ::aether_boost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<volatile ::aether_boost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<const volatile ::aether_boost::ulong_long_type> : public true_type{};

template <> struct is_unsigned< ::aether_boost::long_long_type> : public false_type{};
template <> struct is_unsigned<const ::aether_boost::long_long_type> : public false_type{};
template <> struct is_unsigned<volatile ::aether_boost::long_long_type> : public false_type{};
template <> struct is_unsigned<const volatile ::aether_boost::long_long_type> : public false_type{};
#endif
#if defined(CHAR_MIN) 
#if CHAR_MIN == 0
