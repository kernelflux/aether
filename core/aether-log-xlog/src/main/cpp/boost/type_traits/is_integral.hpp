...
template<> struct is_integral< ::aether_boost::ulong_long_type> : public true_type{};
template<> struct is_integral< ::aether_boost::long_long_type> : public true_type{};
...
template<> struct is_integral<aether_boost::int128_type> : public true_type{};
template<> struct is_integral<aether_boost::uint128_type> : public true_type{};
#endif
