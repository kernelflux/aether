...
{
   typedef typename remove_cv<T>::type no_cv_t;
   BOOST_STATIC_CONSTANT(bool, value = (!(::aether_boost::detail::is_signed_values<T>::minus_one  > aether_boost::detail::is_signed_values<T>::zero)));
};
...
{
   typedef ::aether_boost::detail::is_signed_select_helper< ::aether_boost::is_integral<T>::value || ::aether_boost::is_enum<T>::value> selector;
...
template <class T> struct is_signed : public integral_constant<bool, aether_boost::detail::is_signed_impl<T>::value> {};
...
template <> struct is_signed< ::aether_boost::long_long_type> : public true_type{};
template <> struct is_signed<const ::aether_boost::long_long_type> : public true_type{};
template <> struct is_signed<volatile ::aether_boost::long_long_type> : public true_type{};
template <> struct is_signed<const volatile ::aether_boost::long_long_type> : public true_type{};

template <> struct is_signed< ::aether_boost::ulong_long_type> : public false_type{};
template <> struct is_signed<const ::aether_boost::ulong_long_type> : public false_type{};
template <> struct is_signed<volatile ::aether_boost::ulong_long_type> : public false_type{};
template <> struct is_signed<const volatile ::aether_boost::ulong_long_type> : public false_type{};
#endif
#if defined(CHAR_MIN) 
#if CHAR_MIN != 0
