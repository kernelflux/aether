...
{
    BOOST_STATIC_CONSTANT( bool, ct = aether_boost::is_class<T>::value || aether_boost::is_union<T>::value );
    BOOST_STATIC_CONSTANT( bool, cu = aether_boost::is_class<U>::value || aether_boost::is_union<U>::value );
...
template<class T, class U> struct common_type_class: public aether_boost::conditional<

    aether_boost::is_convertible<T, U>::value && !aether_boost::is_convertible<U, T>::value,
    aether_boost::type_identity<U>,

    typename aether_boost::conditional<

        aether_boost::is_convertible<U, T>::value && !aether_boost::is_convertible<T, U>::value,
        aether_boost::type_identity<T>,
...
template<class T, class U> struct common_type_impl: public aether_boost::conditional<
    ct_class<T, U>::value,
...
template<class T, class U> struct common_type_impl3: public aether_boost::conditional<
    aether_boost::is_pointer<T>::value || aether_boost::is_pointer<U>::value,
...
template<class T, class U> struct common_type_impl4: public aether_boost::conditional<
    aether_boost::is_member_pointer<T>::value || aether_boost::is_member_pointer<U>::value,
