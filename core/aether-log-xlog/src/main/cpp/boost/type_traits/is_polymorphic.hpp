...
{
   typedef is_polymorphic_selector< ::aether_boost::is_class<T>::value> selector;
...
template <class T> struct is_polymorphic : public integral_constant<bool, ::aether_boost::detail::is_polymorphic_imp<T>::value> {};
