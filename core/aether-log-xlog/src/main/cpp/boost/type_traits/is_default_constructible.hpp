...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost{
   ...
   template <class T> struct is_default_constructible : public integral_constant<bool, sizeof(detail::is_default_constructible_imp::test<T>(0)) == sizeof(aether_boost::type_traits::yes_type)>{};
