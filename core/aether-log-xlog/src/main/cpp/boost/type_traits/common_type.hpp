...
template<class T> struct common_type<T>: aether_boost::decay<T>
{
};
...
template<class T1, class T2> using builtin_common_type = typename aether_boost::decay<decltype( aether_boost::declval<bool>()? aether_boost::declval<T1>(): aether_boost::declval<T2>() )>::type;
...
template<class T1, class T2> using builtin_common_type = decltype( aether_boost::declval<bool>()? aether_boost::declval<T1>(): aether_boost::declval<T2>() );

template<class T1, class T2> struct common_type_impl_2: mp_defer<builtin_common_type, T1, T2>
{
};

template<class T1, class T2> using decay_common_type = typename aether_boost::decay<typename common_type_impl_2<T1, T2>::type>::type;
...
template<class T1, class T2> struct common_type_impl: aether_boost::decay<decltype( aether_boost::declval<bool>()? aether_boost::declval<T1>(): aether_boost::declval<T2>() )>
{
};
...
template<class T1, class T2, class T1d = typename aether_boost::decay<T1>::type, class T2d = typename aether_boost::decay<T2>::type> struct common_type_decay_helper: aether_boost::common_type<T1d, T2d>
{
};
