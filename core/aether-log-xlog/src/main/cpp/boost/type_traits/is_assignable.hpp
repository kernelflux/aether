...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost{
   ...
   namespace detail{
      ...
      {
         template<typename T, typename U, typename = decltype(aether_boost::declval<T>() = aether_boost::declval<U>())>
   ...
   template <class T, class U> struct is_assignable : public integral_constant<bool, sizeof(detail::is_assignable_imp::test<T, U>(0)) == sizeof(aether_boost::type_traits::yes_type)>{};
