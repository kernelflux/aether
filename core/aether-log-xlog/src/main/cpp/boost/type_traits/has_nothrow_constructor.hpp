...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost { namespace detail{
   ...
   template <class T, bool b> struct has_nothrow_constructor_imp : public aether_boost::integral_constant<bool, false>{};
   template <class T> struct has_nothrow_constructor_imp<T, true> : public aether_boost::integral_constant<bool, noexcept(T())>{};
...
template <class T> struct has_nothrow_constructor : public ::aether_boost::has_trivial_constructor<T> {};
