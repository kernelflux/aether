...
struct false_or_cpp11_noexcept_move_assignable: public ::aether_boost::false_type {};

template <class T>
struct false_or_cpp11_noexcept_move_assignable <
        T,
        typename ::aether_boost::enable_if_c<sizeof(T) && BOOST_NOEXCEPT_EXPR(::aether_boost::declval<T&>() = ::aether_boost::declval<T>())>::type
    > : public ::aether_boost::integral_constant<bool, BOOST_NOEXCEPT_EXPR(::aether_boost::declval<T&>() = ::aether_boost::declval<T>())>
{};

}

template <class T>
struct is_nothrow_move_assignable : public integral_constant<bool, ::aether_boost::detail::false_or_cpp11_noexcept_move_assignable<T>::value>{};

template <class T> struct is_nothrow_move_assignable<T const> : public ::aether_boost::false_type {};
template <class T> struct is_nothrow_move_assignable<T const volatile> : public ::aether_boost::false_type{};
template <class T> struct is_nothrow_move_assignable<T volatile> : public ::aether_boost::false_type{};
template <class T> struct is_nothrow_move_assignable<T&> : public ::aether_boost::false_type{};
...
struct is_nothrow_move_assignable : public integral_constant<bool,
   (::aether_boost::has_trivial_move_assign<T>::value || ::aether_boost::has_nothrow_assign<T>::value) &&  ! ::aether_boost::is_array<T>::value>{};
