...
namespace posix_time {
  ...
  inline
  std::tm to_tm(const aether_boost::posix_time::ptime& t) {
    std::tm timetm = aether_boost::gregorian::to_tm(t.date());
    aether_boost::posix_time::time_duration td = t.time_of_day();
  ...
  inline
  std::tm to_tm(const aether_boost::posix_time::time_duration& td) {
    std::tm timetm;
  ...
  ptime ptime_from_tm(const std::tm& timetm) {
    aether_boost::gregorian::date d = aether_boost::gregorian::date_from_tm(timetm);
  ...
  {
    return aether_boost::date_time::time_from_ftime<TimeT>(ft);
  }

#endif // BOOST_HAS_FTIME

} } //namespace aether_boost::posix_time
