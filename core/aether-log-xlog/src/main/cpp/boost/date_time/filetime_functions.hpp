...
namespace winapi {
    ...
    extern "C" {
        ...
        struct FILETIME
        {
            aether_boost::uint32_t dwLowDateTime;
            aether_boost::uint32_t dwHighDateTime;
        };
        struct SYSTEMTIME
        {
            aether_boost::uint16_t wYear;
            aether_boost::uint16_t wMonth;
            aether_boost::uint16_t wDayOfWeek;
            aether_boost::uint16_t wDay;
            aether_boost::uint16_t wHour;
            aether_boost::uint16_t wMinute;
            aether_boost::uint16_t wSecond;
            aether_boost::uint16_t wMilliseconds;
        };
     ...
     *       aether_boost::date_time::winapi::file_time type.
     */
    template< typename FileTimeT >
    inline aether_boost::uint64_t file_time_to_microseconds(FileTimeT const& ft)
    {
