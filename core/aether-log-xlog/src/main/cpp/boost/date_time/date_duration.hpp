...
namespace date_time {
  ...
  class date_duration : private
              aether_boost::less_than_comparable1< date_duration< duration_rep_traits >
            , aether_boost::equality_comparable1< date_duration< duration_rep_traits >
            , aether_boost::addable1< date_duration< duration_rep_traits >
            , aether_boost::subtractable1< date_duration< duration_rep_traits >
            , aether_boost::dividable2< date_duration< duration_rep_traits >, int
            > > > > >
  {
  public:
  ...
  {
    typedef long int_type;
    typedef aether_boost::date_time::int_adapter<long> impl_type;
