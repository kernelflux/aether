...
#define BOOST_MOVE_CATCH_CONST(U)  \
   typename ::aether_boost::move_detail::if_< ::aether_boost::move_detail::is_class<U>, BOOST_CATCH_CONST_RLVALUE(U), const U &>::type
#define BOOST_MOVE_CATCH_RVALUE(U)\
   typename ::aether_boost::move_detail::if_< ::aether_boost::move_detail::is_class<U>, BOOST_RV_REF(U), ::aether_boost::move_detail::nat>::type
...
////////////////////////////////////////
   ...
   #define BOOST_MOVE_CONVERSION_AWARE_CATCH_COMMON(PUB_FUNCTION, TYPE, RETURN_VALUE, FWD_FUNCTION)\
      ...
      {  return FWD_FUNCTION(::aether_boost::move(x));  }\
      \
   ...
   //
      ...
      #define BOOST_MOVE_CONVERSION_AWARE_CATCH(PUB_FUNCTION, TYPE, RETURN_VALUE, FWD_FUNCTION)\
         ...
         RETURN_VALUE PUB_FUNCTION(const BOOST_MOVE_TEMPL_PARAM &u,\
            typename ::aether_boost::move_detail::enable_if_and\
                                 < ::aether_boost::move_detail::nat \
                                 , ::aether_boost::move_detail::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM>\
                                 , ::aether_boost::move_detail::is_class<TYPE>\
                                 , ::aether_boost::has_move_emulation_disabled<BOOST_MOVE_TEMPL_PARAM>\
                                 >::type* = 0)\
         { return FWD_FUNCTION(u); }\
         \
         template<class BOOST_MOVE_TEMPL_PARAM>\
         RETURN_VALUE PUB_FUNCTION(const BOOST_MOVE_TEMPL_PARAM &u,\
            typename ::aether_boost::move_detail::disable_if_or\
                              < ::aether_boost::move_detail::nat \
                              , ::aether_boost::move_detail::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM> \
                              , ::aether_boost::move_detail::and_ \
                                 < ::aether_boost::move_detail::is_rv<BOOST_MOVE_TEMPL_PARAM> \
                                 , ::aether_boost::move_detail::is_class<BOOST_MOVE_TEMPL_PARAM> \
                                 > \
                              >::type* = 0)\
         {\
            TYPE t(u);\
            return FWD_FUNCTION(::aether_boost::move(t));\
         }\
      //
   #else
      #define BOOST_MOVE_CONVERSION_AWARE_CATCH(PUB_FUNCTION, TYPE, RETURN_VALUE, FWD_FUNCTION)\
   ...
   #define BOOST_MOVE_CONVERSION_AWARE_CATCH(PUB_FUNCTION, TYPE, RETURN_VALUE, FWD_FUNCTION)\
      ...
      \
      template<class BOOST_MOVE_TEMPL_PARAM>\
      typename ::aether_boost::move_detail::enable_if_c\
                        < !::aether_boost::move_detail::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM>::value\
                        , RETURN_VALUE >::type\
      PUB_FUNCTION(const BOOST_MOVE_TEMPL_PARAM &u)\
      {\
         TYPE t(u);\
...
////////////////////////////////////////
   ...
   #define BOOST_MOVE_CONVERSION_AWARE_CATCH_1ARG_COMMON(PUB_FUNCTION, TYPE, RETURN_VALUE, FWD_FUNCTION, ARG1, UNLESS_CONVERTIBLE_TO)\
      ...
      {  return FWD_FUNCTION(arg1, ::aether_boost::move(x));  }\
      \
      ...
      #define BOOST_MOVE_CONVERSION_AWARE_CATCH_1ARG(PUB_FUNCTION, TYPE, RETURN_VALUE, FWD_FUNCTION, ARG1, UNLESS_CONVERTIBLE_TO)\
         ...
         RETURN_VALUE PUB_FUNCTION(ARG1 arg1, const BOOST_MOVE_TEMPL_PARAM &u,\
            typename ::aether_boost::move_detail::disable_if_or\
                              ...
                              , ::aether_boost::move_detail::is_rv<BOOST_MOVE_TEMPL_PARAM>\
                              , ::aether_boost::move_detail::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM>\
                              , ::aether_boost::move_detail::is_convertible<BOOST_MOVE_TEMPL_PARAM, UNLESS_CONVERTIBLE_TO>\
                              >::type* = 0)\
         {\
            TYPE t(u);\
            return FWD_FUNCTION(arg1, ::aether_boost::move(t));\
         }\
      //
   #else
      #define BOOST_MOVE_CONVERSION_AWARE_CATCH_1ARG(PUB_FUNCTION, TYPE, RETURN_VALUE, FWD_FUNCTION, ARG1, UNLESS_CONVERTIBLE_TO)\
