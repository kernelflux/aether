...
// @endcond
   ...
   template <class T>
   class rv
      : public ::aether_boost::move_detail::if_c
         < ::aether_boost::move_detail::is_class<T>::value
         , T
         , ::aether_boost::move_detail::nat
         >::type
   {
      rv();
      ~rv() throw();
   ...
   struct is_rv
      ...
      : integral_constant<bool, ::aether_boost::move_detail::is_rv_impl<T>::value >
   {};
   ...
   struct has_move_emulation_enabled
      : ::aether_boost::move_detail::has_move_emulation_enabled_impl<T>
   {};

   template<class T>
   struct has_move_emulation_disabled
   {
      static const bool value = !::aether_boost::move_detail::has_move_emulation_enabled_impl<T>::value;
   };

   }  //namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost {

   #define BOOST_RV_REF(TYPE)\
      ::aether_boost::rv< TYPE >& \
   //

   #define BOOST_RV_REF_2_TEMPL_ARGS(TYPE, ARG1, ARG2)\
      ::aether_boost::rv< TYPE<ARG1, ARG2> >& \
   //

   #define BOOST_RV_REF_3_TEMPL_ARGS(TYPE, ARG1, ARG2, ARG3)\
      ::aether_boost::rv< TYPE<ARG1, ARG2, ARG3> >& \
   //
   ...
   #define BOOST_COPY_ASSIGN_REF(TYPE)\
      const ::aether_boost::rv< TYPE >& \
   //

   #define BOOST_COPY_ASSIGN_REF_BEG \
      const ::aether_boost::rv<  \
   //
   ...
   #define BOOST_COPY_ASSIGN_REF_2_TEMPL_ARGS(TYPE, ARG1, ARG2)\
      const ::aether_boost::rv< TYPE<ARG1, ARG2> >& \
   //

   #define BOOST_COPY_ASSIGN_REF_3_TEMPL_ARGS(TYPE, ARG1, ARG2, ARG3)\
      const ::aether_boost::rv< TYPE<ARG1, ARG2, ARG3> >& \
   //
   ...
   inline typename ::aether_boost::move_detail::enable_if_c
      <  ::aether_boost::move_detail::is_lvalue_reference<Ret>::value ||
        !::aether_boost::has_move_emulation_enabled<T>::value
      , T&>::type
   ...
   inline typename ::aether_boost::move_detail::enable_if_c
      < !::aether_boost::move_detail::is_lvalue_reference<Ret>::value &&
         ::aether_boost::has_move_emulation_enabled<T>::value
      , ::aether_boost::rv<T>&>::type
         move_return(::aether_boost::rv<T>& x) BOOST_NOEXCEPT
   {
      return x;
   }
   ...
   #define BOOST_MOVE_RET(RET_TYPE, REF)\
      aether_boost::move_detail::move_return< RET_TYPE >(REF)
   //

   #define BOOST_MOVE_BASE(BASE_TYPE, ARG) \
      ::aether_boost::move((BASE_TYPE&)(ARG))
   //
   ...
   #define BOOST_MOVABLE_BUT_NOT_COPYABLE(TYPE)\
      ...
      public:\
      operator ::aether_boost::rv<TYPE>&() \
      {  return *BOOST_MOVE_TO_RV_CAST(::aether_boost::rv<TYPE>*, this);  }\
      operator const ::aether_boost::rv<TYPE>&() const \
      {  return *BOOST_MOVE_TO_RV_CAST(const ::aether_boost::rv<TYPE>*, this);  }\
      private:\
   //
   ...
   template< class T>
   struct forward_type< aether_boost::rv<T> >
   { typedef T type; };
   ...
   //!cast to the base type before calling `::aether_boost::move()` due to rvalue reference limitations.
   //!
