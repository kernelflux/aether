...
};  // aether_boost::integer::gcd_evaluator
...
};  // aether_boost::integer::lcm_evaluator
...
#define BOOST_PRIVATE_GCD_UF( Ut )                  \
    ...
    BOOST_PRIVATE_GCD_UF( aether_boost::ulong_long_type );
...
#ifdef BOOST_HAS_LONG_LONG
    BOOST_PRIVATE_GCD_SF( aether_boost::long_long_type, aether_boost::ulong_long_type );
#elif defined(BOOST_HAS_MS_INT64)
