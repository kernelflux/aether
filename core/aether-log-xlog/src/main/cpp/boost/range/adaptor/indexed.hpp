...
public:
    ...
    index_type index()
    {
        return aether_boost::tuples::get<0>(*this);
    }
    ...
    value_type value()
    {
        return aether_boost::tuples::get<1>(*this);
    }
    ...
    >
{
    ...
    BOOST_RANGE_CONCEPT_ASSERT((
        aether_boost::SinglePassRangeConcept<SinglePassRange>));
public:
    ...
    indexed_range(
        ...
        : base_t(iterator(aether_boost::begin(r), i),
                 iterator(aether_boost::end(r), i))
    {
    }
    ...
    indexed_range(
        ...
        : base_t(iterator(aether_boost::begin(r), i),
                 iterator(aether_boost::end(r), i + aether_boost::size(r)))
    {
    }
};
...
{
    BOOST_RANGE_CONCEPT_ASSERT((
        aether_boost::SinglePassRangeConcept<const SinglePassRange>
    ));
