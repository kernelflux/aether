...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost
{
    namespace range_detail
    {
        ...
        class skip_iterator
          : public aether_boost::iterator_adaptor<
        ...
        {
        private:
            typedef aether_boost::iterator_adaptor<
                        skip_iterator<Iter,Pred,default_pass>,
                        Iter,
                        BOOST_DEDUCED_TYPENAME std::iterator_traits<Iter>::value_type,
                        aether_boost::forward_traversal_tag,
        ...
        public:
            ...
            : base_range(skip_iter(aether_boost::begin(r), aether_boost::end(r), p),
                         skip_iter(aether_boost::end(r), aether_boost::end(r), p))
            {
            }
        };
