...
{
    typedef typename aether_boost::mpl::if_<
        aether_boost::is_array<Sep>,
        const typename aether_boost::remove_extent<Sep>::type*,
        Sep
    >::type separator_t;

    typedef typename aether_boost::mpl::if_<
        aether_boost::is_array<Prefix>,
        const typename aether_boost::remove_extent<Prefix>::type*,
        Prefix
    >::type prefix_t;

    typedef typename aether_boost::mpl::if_<
        aether_boost::is_array<Postfix>,
        const typename aether_boost::remove_extent<Postfix>::type*,
        Postfix
    >::type postfix_t;
...
)
{
    ...
    return range_detail::formatted_range<iterator, Sep, Prefix, Postfix>(
        aether_boost::begin(rng), aether_boost::end(rng), holder);
}
...
template<typename SinglePassRange, typename Sep, typename Prefix,
         typename Postfix>
inline aether_boost::range_detail::formatted_range<
    typename aether_boost::range_iterator<const SinglePassRange>::type,
    Sep, Prefix, Postfix
>
format(
    const SinglePassRange& rng,
...
{
    typedef typename aether_boost::range_iterator<const SinglePassRange>::type
                iterator_t;

    typedef aether_boost::range_detail::formatted_range<
                iterator_t, Sep, Prefix, Postfix>       result_t;

    typedef aether_boost::range_detail::formatted_holder<Sep, Prefix, Postfix>
                holder_t;

    return result_t(aether_boost::begin(rng), aether_boost::end(rng),
...
format(const SinglePassRange& rng)
{
    ...
    namespace range
    {
        using aether_boost::range_detail::formatted_range;
    } // namespace range
} // namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost
