...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost
{
    namespace adaptors
    {
        ...
        class sliced_range : public aether_boost::iterator_range< BOOST_DEDUCED_TYPENAME range_iterator<RandomAccessRange>::type >
        {
            typedef aether_boost::iterator_range< BOOST_DEDUCED_TYPENAME range_iterator<RandomAccessRange>::type > base_t;
        public:
            template<typename Rng, typename T, typename U>
            sliced_range(Rng& rng, T t, U u)
                : base_t(aether_boost::next(aether_boost::begin(rng), t),
                         aether_boost::next(aether_boost::begin(rng), u))
            {
            }
        };
        ...
        slice( RandomAccessRange& rng, std::size_t t, std::size_t u )
        {
            ...
            BOOST_ASSERT( static_cast<std::size_t>(aether_boost::size(rng)) >= u &&
