...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost
{
    namespace range_detail
    {
        ...
        struct reversed_range : 
            public aether_boost::iterator_range<
                      aether_boost::reverse_iterator<
        ...
        public:
            typedef aether_boost::reverse_iterator<BOOST_DEDUCED_TYPENAME range_iterator<R>::type> iterator;

            explicit reversed_range( R& r ) 
                : base( iterator(aether_boost::end(r)), iterator(aether_boost::begin(r)) )
            { }
        };
