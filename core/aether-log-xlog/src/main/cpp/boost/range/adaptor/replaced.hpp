...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost
{
    namespace range_detail
    {
        ...
        private:
            ...
            aether_boost::optional<data> m_impl;
        };

        template< class R >
        class replaced_range :
            public aether_boost::iterator_range<
                aether_boost::transform_iterator<
        ...
        public:
            ...
            replaced_range( R& r, value_type from, value_type to )
                : base_t( make_transform_iterator( aether_boost::begin(r), Fn(from, to) ),
                          make_transform_iterator( aether_boost::end(r), Fn(from, to) ) )
            { }
        };
