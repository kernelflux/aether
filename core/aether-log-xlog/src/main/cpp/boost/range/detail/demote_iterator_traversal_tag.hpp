...
struct demote_iterator_traversal_tag
    : inner_demote_iterator_traversal_tag<
        typename aether_boost::iterators::pure_traversal_tag< IteratorTraversalTag1 >::type,
        typename aether_boost::iterators::pure_traversal_tag< IteratorTraversalTag2 >::type
      >
{
};
