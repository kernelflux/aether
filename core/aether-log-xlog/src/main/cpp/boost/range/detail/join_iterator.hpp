...
public:
    ...
    join_iterator(Range1& r1, Range2& r2, join_iterator_begin_tag)
        : m_section(aether_boost::empty(r1) ? 1u : 0u)
        , m_it(aether_boost::empty(r1) ? 1u : 0u, aether_boost::begin(r1), aether_boost::begin(r2))
        , m_link(link_t(aether_boost::end(r1), aether_boost::begin(r2)))
    {
    }
    ...
    join_iterator(const Range1& r1, const Range2& r2, join_iterator_begin_tag)
        : m_section(aether_boost::empty(r1) ? 1u : 0u)
        , m_it(aether_boost::empty(r1) ? 1u : 0u, aether_boost::const_begin(r1), aether_boost::const_begin(r2))
        , m_link(link_t(aether_boost::const_end(r1), aether_boost::const_begin(r2)))
    {
    }
    ...
    join_iterator(Range1& r1, Range2& r2, join_iterator_end_tag)
        : m_section(1u)
        , m_it(1u, aether_boost::end(r1), aether_boost::end(r2))
        , m_link(link_t(aether_boost::end(r1), aether_boost::begin(r2)))
    {
    }
    ...
    join_iterator(const Range1& r1, const Range2& r2, join_iterator_end_tag)
        : m_section(1u)
        , m_it(1u, aether_boost::const_end(r1), aether_boost::const_end(r2))
        , m_link(link_t(aether_boost::const_end(r1), aether_boost::const_begin(r2)))
    {
    }
...
private:
    ...
    void decrement()
    {
        if (m_section)
        {
            ...
            {
                m_it.it1() = aether_boost::prior(m_link.last1);
                m_section = 0u;
            }
            else
                --m_it.it2();
