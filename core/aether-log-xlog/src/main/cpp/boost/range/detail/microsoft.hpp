...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost { namespace range_detail_microsoft {
    ...
    size_of(T const& x)
    {
        return std::distance(aether_boost::begin(x), aether_boost::end(x));
    }
...
} } // namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost::range_detail_microsoft
...
/**/
    ...
    #define BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE_begin(Fullname) \
        inline \
        aether_boost::range_detail_microsoft::mutable_iterator_of< Fullname >::type \
        BOOST_RANGE_DETAIL_MICROSOFT_range_begin(Fullname& x) \
        { \
            return aether_boost::range_detail_microsoft::begin_of(x); \
        } \
    /**/
    ...
    #define BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE_begin_const(Fullname) \
        inline \
        aether_boost::range_detail_microsoft::const_iterator_of< Fullname >::type \
    ...
    #define BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE_end(Fullname) \
        ...
        { \
            return aether_boost::range_detail_microsoft::end_of(x); \
        } \
    /**/
    ...
    /**/
        ...
        #define BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE_size(Fullname) \
            inline \
            aether_boost::range_detail_microsoft::size_type_of< Fullname >::type \
            boost_range_size(Fullname const& x) \
            { \
                return aether_boost::range_detail_microsoft::size_of(x); \
            } \
        /**/
...
/**/
    ...
    #define BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE_begin(Params, Fullname) \
        ...
        typename aether_boost::range_detail_microsoft::mutable_iterator_of< Fullname >::type \
        BOOST_RANGE_DETAIL_MICROSOFT_range_begin(Fullname& x) \
        { \
            return aether_boost::range_detail_microsoft::begin_of(x); \
        } \
    ...
    #define BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE_begin_const(Params, Fullname) \
        template< Params > inline \
        typename aether_boost::range_detail_microsoft::const_iterator_of< Fullname >::type \
        BOOST_RANGE_DETAIL_MICROSOFT_range_begin(Fullname const& x) \
        { \
            return aether_boost::range_detail_microsoft::begin_of(x); \
        } \
    ...
    /**/
        ...
        #define BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE_size(Params, Fullname) \
            template< Params > inline \
            typename aether_boost::range_detail_microsoft::size_type_of< Fullname >::type \
            boost_range_size(Fullname const& x) \
            { \
                return aether_boost::range_detail_microsoft::size_of(x); \
            } \
...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost { namespace range_detail_microsoft {
    ...
    public:
        ...
        explicit list_iterator(ListT& lst, POSITION pos) :
            m_plst(aether_boost::addressof(lst)), m_pos(pos)
        { }
...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost { namespace range_detail_microsoft {
    ...
    {
        return
            aether_boost::distance(rng1) == aether_boost::distance(rng2) &&
            std::equal(aether_boost::begin(rng1), aether_boost::end(rng1), aether_boost::begin(rng2))
        ;
    }
    ...
    {
        typedef typename aether_boost::range_const_iterator<AssocContainer>::type iter_t;
        for (iter_t it = aether_boost::const_begin(ac), last = aether_boost::const_end(ac); it != last; ++it) {
    ...
    bool test_emptiness(Range& )
    {
        ...
        Range emptyRng;
        result = result && aether_boost::empty(emptyRng);
    ...
    bool test_trivial(Range& rng)
    {
        ...
        citer_t cit = aether_boost::begin(rng);
        (void)cit; // unused
    ...
    {
        aether_boost::function_requires< ForwardRangeConcept<Range> >();
        ...
        std::copy(aether_boost::begin(rng), aether_boost::end(rng), std::back_inserter(saved));
        std::rotate(aether_boost::begin(saved), aether_boost::next(aether_boost::begin(saved)), aether_boost::end(saved));

        std::rotate(aether_boost::begin(rng), aether_boost::next(aether_boost::begin(rng)), aether_boost::end(rng));
    ...
    {
        aether_boost::function_requires< BidirectionalRangeConcept<Range> >();
        ...
        result = result && (test_equals)(
            aether_boost::make_iterator_range(aether_boost::rbegin(saved), aether_boost::rend(saved)),
            aether_boost::make_iterator_range(aether_boost::rbegin(rng), aether_boost::rend(rng))
        );
    ...
    {
        aether_boost::function_requires< RandomAccessRangeConcept<Range> >();
        ...
        std::vector<val_t> saved;
        std::copy(aether_boost::begin(rng), aether_boost::end(rng), std::back_inserter(saved));
        std::sort(aether_boost::begin(saved), aether_boost::end(saved));

        std::random_shuffle(aether_boost::begin(rng), aether_boost::end(rng));
        std::sort(aether_boost::begin(rng), aether_boost::end(rng));
        result = result && (test_equals)(rng, saved);

        std::random_shuffle(aether_boost::begin(rng), aether_boost::end(rng));
        std::stable_sort(aether_boost::begin(rng), aether_boost::end(rng));
        result = result && (test_equals)(rng, saved);

        std::random_shuffle(aether_boost::begin(rng), aether_boost::end(rng));
        std::partial_sort(aether_boost::begin(rng), aether_boost::end(rng), aether_boost::end(rng));
        result = result && (test_equals)(rng, saved);
    ...
    bool test_init_array(ArrayT& arr, SampleRange const& sample)
    {
        ...
        for (iter_t it = aether_boost::const_begin(sample), last = aether_boost::const_end(sample); it != last; ++it) {
    ...
    bool test_init_map(MapT& map, SampleMap const& sample)
    {
        ...
        return aether_boost::distance(map) == aether_boost::distance(sample);
    }
    ...
    struct test_mutable_iter :
        aether_boost::is_same< typename aether_boost::BOOST_RANGE_DETAIL_MICROSOFT_range_mutable_iterator<Range>::type, Iter >
    { };


    template< class Range, class Iter >
    struct test_const_iter :
        aether_boost::is_same< typename aether_boost::range_const_iterator<Range>::type, Iter >
    { };
