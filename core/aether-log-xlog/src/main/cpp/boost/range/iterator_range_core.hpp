...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost
{
    namespace iterator_range_detail
    {
        ...
        struct iterator_range_impl {
            ...
            {
                return IteratorT( aether_boost::begin( r ) );
            }

            template< class ForwardRange >
            static IteratorT adl_end( ForwardRange& r )
            {
                return IteratorT( aether_boost::end( r ) );
            }
        };
        ...
        {
            return std::lexicographical_compare( aether_boost::begin(l),
                                                 aether_boost::end(l),
                                                 aether_boost::begin(r),
                                                 aether_boost::end(r) );
        }
...
incrementable_t test_traversal_tag(aether_boost::incrementable_traversal_tag);
bidirectional_t test_traversal_tag(aether_boost::bidirectional_traversal_tag);
random_access_t test_traversal_tag(aether_boost::random_access_traversal_tag);

template<std::size_t S>
struct pure_iterator_traversal_impl
{
    typedef aether_boost::incrementable_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(bidirectional_t)>
{
    typedef aether_boost::bidirectional_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(random_access_t)>
{
    typedef aether_boost::random_access_traversal_tag type;
};
    ...
    typedef BOOST_DEDUCED_TYPENAME
        aether_boost::mpl::if_<
            aether_boost::mpl::or_<
                aether_boost::is_abstract<
                    BOOST_DEDUCED_TYPENAME base_type::value_type
                >,
                aether_boost::is_array<
                    BOOST_DEDUCED_TYPENAME base_type::value_type
                >,
                aether_boost::is_function<
                    BOOST_DEDUCED_TYPENAME base_type::value_type
                >
            >,
...
//  iterator range template class -----------------------------------------//
        ...
        /*!
            ...
            \code
                aether_boost::tolower( find( s, "UPPERCASE STRING" ) );
            \endcode
...
//  iterator range free-standing operators ---------------------------//
        ...
        inline BOOST_DEDUCED_TYPENAME aether_boost::enable_if<
...
//  iterator range utilities -----------------------------------------//
        ...
        */
        ...
        {
            return iterator_range<IteratorT>(first, aether_boost::next(first, n));
        }
        ...
        make_iterator_range( Range& r )
        {
            return iterator_range< BOOST_DEDUCED_TYPENAME range_iterator<Range>::type >
                ( aether_boost::begin( r ), aether_boost::end( r ) );
        }
        ...
        namespace iterator_range_detail
        {
                             ...
                             BOOST_DEDUCED_TYPENAME range_difference<Range>::type advance_end )
            {
                ...
                BOOST_DEDUCED_TYPENAME range_iterator<Range>::type
                    new_begin = aether_boost::begin( r ),
                    new_end   = aether_boost::end( r );
        ...
        */
        ...
        {
            return SeqT( aether_boost::begin( r ), aether_boost::end( r ) );
        }
