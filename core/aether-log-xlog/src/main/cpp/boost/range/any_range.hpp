...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost
{
    namespace range_detail
    {
        ...
        // values when the user specified aether_boost::use_default as a template
        // parameter.
        template<
            class T,
            class Default
...
# endif
        ...
        public:
            ...
            : base_type(aether_boost::begin(wrapped_range),
                        aether_boost::end(wrapped_range))
            {
            }
            ...
            any_range(const any_range<
                              ...
                              , Buffer
                            >& other)
            : base_type(aether_boost::begin(other), aether_boost::end(other))
            {
            }
