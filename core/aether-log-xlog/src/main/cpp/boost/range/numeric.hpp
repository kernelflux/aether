...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost
{
    ...
    inline Value accumulate(const SinglePassRange& rng, Value init)
    {
        ...
        return std::accumulate(aether_boost::begin(rng), aether_boost::end(rng), init);
    }
                            ...
                            BinaryOperation op)
    {
        ...
        return std::accumulate(aether_boost::begin(rng), aether_boost::end(rng), init, op);
    }
    ...
    namespace range_detail
    {
        ...
        inline bool inner_product_precondition(
            ...
            std::forward_iterator_tag)
        {
            return aether_boost::size(rng2) >= aether_boost::size(rng1);
        }
        ...
        BinaryOperation2        op2)
    {
        ...
        return std::inner_product(
            aether_boost::begin(rng1), aether_boost::end(rng1),
            aether_boost::begin(rng2), init, op1, op2);
    }
                                      ...
                                      OutputIterator result)
    {
        ...
        return std::partial_sum(aether_boost::begin(rng), aether_boost::end(rng), result);
    }
        ...
        BinaryOperation         op)
    {
        ...
        return std::partial_sum(aether_boost::begin(rng), aether_boost::end(rng), result, op);
    }
        ...
        OutputIterator          result)
    {
        ...
        return std::adjacent_difference(aether_boost::begin(rng), aether_boost::end(rng),
                                        result);
    }
