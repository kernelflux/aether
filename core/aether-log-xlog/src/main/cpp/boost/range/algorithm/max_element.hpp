...
max_element(ForwardRange& rng)
{
    ...
    return std::max_element(aether_boost::begin(rng), aether_boost::end(rng));
}
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( ForwardRangeConcept<ForwardRange> ));
    return std::max_element(aether_boost::begin(rng), aether_boost::end(rng), pred);
}
...
max_element(ForwardRange& rng)
{
    ...
    return range_return<ForwardRange,re>::pack(
        std::max_element(aether_boost::begin(rng), aether_boost::end(rng)),
        rng);
}
...
max_element(ForwardRange& rng, BinaryPredicate pred)
{
    BOOST_RANGE_CONCEPT_ASSERT(( ForwardRangeConcept<ForwardRange> ));
    return range_return<ForwardRange,re>::pack(
        std::max_element(aether_boost::begin(rng), aether_boost::end(rng), pred),
        rng);
}
