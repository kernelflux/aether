...
inline RandomAccessRange& push_heap(RandomAccessRange& rng)
{
    ...
    std::push_heap(aether_boost::begin(rng), aether_boost::end(rng));
    return rng;
}
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( RandomAccessRangeConcept<RandomAccessRange> ));
    std::push_heap(aether_boost::begin(rng), aether_boost::end(rng), comp_pred);
    return rng;
}
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( RandomAccessRangeConcept<RandomAccessRange> ));
    std::pop_heap(aether_boost::begin(rng), aether_boost::end(rng));
    return rng;
}
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( RandomAccessRangeConcept<RandomAccessRange> ));
    std::pop_heap(aether_boost::begin(rng), aether_boost::end(rng), comp_pred);
    return rng;
}
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( RandomAccessRangeConcept<RandomAccessRange> ));
    std::make_heap(aether_boost::begin(rng), aether_boost::end(rng));
    return rng;
}
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( RandomAccessRangeConcept<RandomAccessRange> ));
    std::make_heap(aether_boost::begin(rng), aether_boost::end(rng), comp_pred);
    return rng;
}
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( RandomAccessRangeConcept<RandomAccessRange> ));
    std::sort_heap(aether_boost::begin(rng), aether_boost::end(rng));
    return rng;
}
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( RandomAccessRangeConcept<RandomAccessRange> ));
    std::sort_heap(aether_boost::begin(rng), aether_boost::end(rng), comp_pred);
    return rng;
}
