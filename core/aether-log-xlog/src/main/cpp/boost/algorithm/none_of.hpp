...
{
    return aether_boost::algorithm::none_of (aether_boost::begin (r), aether_boost::end (r), p );
} 
...
{
    return aether_boost::algorithm::none_of_equal (aether_boost::begin (r), aether_boost::end (r), val);
} 
