...
//  iterate find ---------------------------------------------------//
        ...
        /*!
            ...
            \param Result A 'container container' to contain the result of search.
                ...
                Typical type of the result is 
                    \c std::vector<aether_boost::iterator_range<iterator>>
        ...
        */
            ...
            FinderT Finder )
        {
            ...
            iterator_range<BOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_input(::aether_boost::as_literal(Input));
            ...
            input_iterator_type InputEnd=::aether_boost::end(lit_input);

            typedef transform_iterator<copy_range_type, find_iterator_type>
                transform_iter_type;
    
            transform_iter_type itBegin=
                ::aether_boost::make_transform_iterator( 
                    find_iterator_type( ::aether_boost::begin(lit_input), InputEnd, Finder ),
                    copy_range_type());
