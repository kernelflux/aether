...
/*! \file
    ...
    or \c std::list<aether_boost::iterator_range<std::string::iterator>>
*/
...
//  find_all  ------------------------------------------------------------//
        ...
        */
        ...
        {
            return ::aether_boost::algorithm::iter_find(
                Result,
                Input,
                ::aether_boost::algorithm::first_finder(Search) );        
        }
        ...
        */
            ...
            const std::locale& Loc=std::locale() )
        {
            return ::aether_boost::algorithm::iter_find(
                Result,
                Input,
                ::aether_boost::algorithm::first_finder(Search, is_iequal(Loc) ) );        
        }
...
//  tokenize  -------------------------------------------------------------//
        ...
        */
        ...
        {
            return ::aether_boost::algorithm::iter_split(
                Result,
                Input,
                ::aether_boost::algorithm::token_finder( Pred, eCompress ) );         
        }
