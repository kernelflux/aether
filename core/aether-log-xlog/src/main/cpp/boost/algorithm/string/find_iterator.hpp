        ...
        public:
            ...
            */
            ...
            find_iterator(
                ...
                detail::find_iterator_base<IteratorT>(Finder,0)
            {
                iterator_range<BOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_col(::aether_boost::as_literal(Col));
                m_Match=::aether_boost::make_iterator_range(::aether_boost::begin(lit_col), ::aether_boost::begin(lit_col));
                m_End=::aether_boost::end(lit_col);
        ...
        */
        ...
        public:
            ...
            */
            ...
            {
                iterator_range<BOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_col(::aether_boost::as_literal(Col));
                m_Match=make_iterator_range(::aether_boost::begin(lit_col), ::aether_boost::begin(lit_col));
                m_Next=::aether_boost::begin(lit_col);
                m_End=::aether_boost::end(lit_col);
