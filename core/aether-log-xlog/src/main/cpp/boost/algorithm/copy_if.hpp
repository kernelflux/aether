...
{
    return aether_boost::algorithm::copy_if (aether_boost::begin (r), aether_boost::end(r), result, p);
}
...
///
template<typename Range, typename OutputIterator, typename Predicate>
std::pair<typename aether_boost::range_iterator<const Range>::type, OutputIterator>
copy_while ( const Range &r, OutputIterator result, Predicate p )
{
    return aether_boost::algorithm::copy_while (aether_boost::begin (r), aether_boost::end(r), result, p);
}
...
{
    return aether_boost::algorithm::copy_until (aether_boost::begin (r), aether_boost::end(r), result, p);
}
