...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost {  namespace algorithm {
...
///
    ...
    ForwardIterator is_sorted_until ( ForwardIterator first, ForwardIterator last )
    {
        ...
        return aether_boost::algorithm::is_sorted_until ( first, last, std::less<value_type>());
    }
...
///
    ...
    {
        return aether_boost::algorithm::is_sorted_until (first, last, p) == last;
    }
...
///
    ...
    {
        return aether_boost::algorithm::is_sorted_until (first, last) == last;
    }
#endif
...
///
    ...
    typename aether_boost::lazy_disable_if_c<
        aether_boost::is_same<R, Pred>::value,
        typename aether_boost::range_iterator<const R>
    >::type is_sorted_until ( const R &range, Pred p )
    {
        return aether_boost::algorithm::is_sorted_until ( aether_boost::begin ( range ), aether_boost::end ( range ), p );
    }
...
///
    template <typename R>
    typename aether_boost::range_iterator<const R>::type is_sorted_until ( const R &range )
    {
        return aether_boost::algorithm::is_sorted_until ( aether_boost::begin ( range ), aether_boost::end ( range ));
    }
...
///
    template <typename R, typename Pred>
    typename aether_boost::lazy_disable_if_c< aether_boost::is_same<R, Pred>::value, aether_boost::mpl::identity<bool> >::type
    is_sorted ( const R &range, Pred p )
    {
        return aether_boost::algorithm::is_sorted ( aether_boost::begin ( range ), aether_boost::end ( range ), p );
    }
...
///
    ...
    {
        return aether_boost::algorithm::is_sorted ( aether_boost::begin ( range ), aether_boost::end ( range ));
    }
...
///     equal. If that is not what you intended, you should use is_strictly_increasing instead.
    ...
    {
        typedef typename std::iterator_traits<ForwardIterator>::value_type value_type;
        return aether_boost::algorithm::is_sorted (first, last, std::less<value_type>());
    }
...
///     equal. If that is not what you intended, you should use is_strictly_increasing instead.
    ...
    {
        return is_increasing ( aether_boost::begin ( range ), aether_boost::end ( range ));
    }
...
///     equal. If that is not what you intended, you should use is_strictly_decreasing instead.
    ...
    {
        typedef typename std::iterator_traits<ForwardIterator>::value_type value_type;
        return aether_boost::algorithm::is_sorted (first, last, std::greater<value_type>());
    }
...
///     equal. If that is not what you intended, you should use is_strictly_decreasing instead.
    ...
    {
        return is_decreasing ( aether_boost::begin ( range ), aether_boost::end ( range ));
    }
...
///     equal. If that is not what you intended, you should use is_increasing instead.
    ...
    {
        typedef typename std::iterator_traits<ForwardIterator>::value_type value_type;
        return aether_boost::algorithm::is_sorted (first, last, std::less_equal<value_type>());
    }
...
///     equal. If that is not what you intended, you should use is_increasing instead.
    ...
    {
        return is_strictly_increasing ( aether_boost::begin ( range ), aether_boost::end ( range ));
    }
...
///     equal. If that is not what you intended, you should use is_decreasing instead.
    ...
    {
        typedef typename std::iterator_traits<ForwardIterator>::value_type value_type;
        return aether_boost::algorithm::is_sorted (first, last, std::greater_equal<value_type>());
    }
...
///     equal. If that is not what you intended, you should use is_decreasing instead.
    ...
    {
        return is_strictly_decreasing ( aether_boost::begin ( range ), aether_boost::end ( range ));
    }
