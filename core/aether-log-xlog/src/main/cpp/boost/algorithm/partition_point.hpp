...
typename aether_boost::range_iterator<Range> partition_point ( Range &r, Predicate p )
{
    return aether_boost::algorithm::partition_point (aether_boost::begin(r), aether_boost::end(r), p);
}
