...
bool one_of ( InputIterator first, InputIterator last, Predicate p )
{
    ...
    return aether_boost::algorithm::none_of (++i, last, p);
}
...
{
    return aether_boost::algorithm::one_of ( aether_boost::begin (r), aether_boost::end (r), p );
}
...
bool one_of_equal ( InputIterator first, InputIterator last, const V &val )
{
    ...
    if (i == last)
        return false;                    // Didn't occur at all
    return aether_boost::algorithm::none_of_equal (++i, last, val);
}
...
{
    return aether_boost::algorithm::one_of_equal ( aether_boost::begin (r), aether_boost::end (r), val );
} 
