...
#else
        __declspec(thread) aether_boost::detail::thread_data_base* current_thread_data_base;
#endif
...
// Windows CE doesn't define _beginthreadex
        ...
        {
            aether_boost::csbl::unique_ptr<ThreadProxyData> data(reinterpret_cast<ThreadProxyData*>(args));
        ...
        bool win32::scoped_winrt_thread::start(thread_func address, void *parameter, unsigned int *thrdId)
        {
            ...
            *thrdId = ++threadCount;
                ...
                ([address, parameter, completionHandle](ABI::Windows::Foundation::IAsyncAction *)
            {
                ...
                ::aether_boost::detail::thread_data_base* const thread_info(reinterpret_cast<::aether_boost::detail::thread_data_base*>(parameter));
            ...
            if(current_thread_data)
            {
                while(! current_thread_data->tss_data.empty() || current_thread_data->thread_exit_callbacks)
                {
                    while(current_thread_data->thread_exit_callbacks)
                    {
                        ...
                        {
                            (*current_node->func)();
                            aether_boost::detail::heap_delete(current_node->func);
                        }
                        aether_boost::detail::heap_delete(current_node);
                    }
...
#if defined BOOST_THREAD_USES_DATETIME
    bool thread::timed_join(aether_boost::system_time const& wait_until)
    {
      return do_try_join_until(aether_boost::detail::get_milliseconds_until(wait_until));
    }
#endif
...
#pragma warning(pop)
    ...
    {
        aether_boost::cleanup_tls_key();
    }

    BOOST_THREAD_DECL void __cdecl on_thread_exit()
    {
        aether_boost::run_thread_exit_callbacks();
    }
