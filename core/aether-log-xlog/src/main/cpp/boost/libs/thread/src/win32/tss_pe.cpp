...
namespace {
    void NTAPI on_tls_callback(void* , DWORD dwReason, PVOID )
    {
        ...
        {
            aether_boost::aether_booston_thread_exit();
            break;
        }
        }
    }
...
extern "C" {
    ...
    void (* after_ctors )() __attribute__((section(".ctors")))     = aether_boost::on_process_enter;
    void (* before_dtors)() __attribute__((section(".dtors")))     = aether_boost::on_thread_exit;
    void (* after_dtors )() __attribute__((section(".dtors.zzz"))) = aether_boost::on_process_exit;
...
#pragma warning(pop)
        ...
        PVAPI on_process_init()
        {
            ...
            atexit(aether_boost::on_thread_exit);

            //Call Boost process entry callback here

            aether_boost::on_process_enter();
