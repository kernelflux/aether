...
namespace
    ...
    clone_msvc_exception( void * src, cpp_exception_type const & et )
        ...
        if( void * dst = malloc(ti.size) )
            ...
            return aether_boost::shared_ptr<void>(dst,exception_object_deleter(et));
            }
        else
            throw std::bad_alloc();
        }
    ...
    cloned_exception:
        ...
        aether_boost::exception_detail::clone_base const *
        clone() const
            {
    ...
    unsigned long
    exception_cloning_filter( int & result, aether_boost::exception_detail::clone_base const * & ptr, void * info_ )
        {
        ...
        if( is_cpp_exception(record) )
            ...
            if( is_cpp_exception(record) && record->ExceptionInformation[2] )
                try
                    ...
                    result = aether_boost::exception_detail::clone_current_exception_result::success;
                    }
                catch(
                std::bad_alloc & )
                    {
                    result = aether_boost::exception_detail::clone_current_exception_result::bad_alloc;
                    }
                catch(
                ... )
                    {
                    result = aether_boost::exception_detail::clone_current_exception_result::bad_exception;
                    }
            }
...
namespace aether_boost {} namespace boost = aether_boost; namespace
aether_boost
    {
    namespace
    exception_detail
