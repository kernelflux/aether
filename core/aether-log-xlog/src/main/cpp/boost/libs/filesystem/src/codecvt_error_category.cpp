...
namespace
{
  class codecvt_error_cat : public aether_boost::system::error_category
  {
  public:
    codecvt_error_cat(){}
...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost
{
  namespace filesystem
  {
    ...
    BOOST_FILESYSTEM_DECL const aether_boost::system::error_category& codecvt_error_category()
    {
