...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost { namespace filesystem {
...
namespace path_traits {
  ...
  template <class Container> inline
    ...
    typename aether_boost::disable_if<aether_boost::is_array<Container>, bool>::type
  ...
  template <class Container, class U> inline
    ...
    typename aether_boost::disable_if<aether_boost::is_array<Container>, void>::type
