/*
  A variadic implementation of variadic aether_boost::signals2::signal, used when variadic
...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost
{
  namespace signals2
  {
    namespace detail
    {
      ...
      {
      public:
        typedef aether_boost::function<R (const aether_boost::signals2::connection &, Args...)> function_type;
      };
    } // namespace detail
  } // namespace signals2
