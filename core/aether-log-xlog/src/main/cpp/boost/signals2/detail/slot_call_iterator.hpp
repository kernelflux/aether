  ...
  namespace signals2 {
    namespace detail {
      ...
      class slot_call_iterator_t
        : public aether_boost::iterator_facade<slot_call_iterator_t<Function, Iterator, ConnectionBody>,
        typename Function::result_type,
        aether_boost::single_pass_traversal_tag,
        typename aether_boost::add_const<typename aether_boost::add_reference<typename Function::result_type>::type>::type >
      {
        typedef aether_boost::iterator_facade<slot_call_iterator_t<Function, Iterator, ConnectionBody>,
          typename Function::result_type,
          aether_boost::single_pass_traversal_tag,
          typename aether_boost::add_const<typename aether_boost::add_reference<typename Function::result_type>::type>::type >
        inherited;
