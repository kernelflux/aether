...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost
{
  ...
  namespace signals2
  {
    ...
    {};
    template<typename T> struct weak_ptr_traits<aether_boost::weak_ptr<T> >
    {
      typedef aether_boost::shared_ptr<T> shared_type;
    };
#ifndef BOOST_NO_CXX11_SMART_PTR
    ...
    template<typename T> struct shared_ptr_traits<aether_boost::shared_ptr<T> >
    {
      typedef aether_boost::weak_ptr<T> weak_type;
    };
#ifndef BOOST_NO_CXX11_SMART_PTR
    ...
    namespace detail
    {
      ...
      private:
        aether_boost::scoped_ptr<foreign_weak_ptr_impl_base> _p;
      };
    } // namespace detail
