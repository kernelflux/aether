/*
  Helper class used by variadic implementation of variadic aether_boost::signals2::signal.
...
// if compiler has std::tuple use it instead of aether_boost::tuple
// because aether_boost::tuple does not have variadic template support at present.
#ifdef BOOST_NO_CXX11_HDR_TUPLE
#include <boost/tuple/tuple.hpp>
#define BOOST_SIGNALS2_TUPLE aether_boost::tuple
#define BOOST_SIGNALS2_GET aether_boost::get
#else
#include <tuple>
      ...
      private:
        template<typename Func, unsigned ... indices, typename ... Args>
          R m_invoke(Func &func, unsigned_meta_array<indices...>, BOOST_SIGNALS2_TUPLE<Args...> args,
            typename aether_boost::disable_if<aether_boost::is_void<typename Func::result_type> >::type * = 0
          ) const
        {
        ...
        template<typename Func, unsigned ... indices, typename ... Args>
          R m_invoke(Func &func, unsigned_meta_array<indices...>, BOOST_SIGNALS2_TUPLE<Args...> args,
            typename aether_boost::enable_if<aether_boost::is_void<typename Func::result_type> >::type * = 0
          ) const
        {
