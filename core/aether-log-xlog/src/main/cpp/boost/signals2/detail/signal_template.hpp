...
// signalN::slot_function
      ...
      private:
        ...
        aether_boost::shared_ptr<connection> _connection;
      };
...
#define BOOST_SIGNALS2_M_ARG_NAMES(arity) BOOST_PP_ENUM(arity, BOOST_SIGNALS2_M_ARG_NAME, ~)
          ...
          result_type m_invoke(const connection_body_type &connectionBody,
            typename aether_boost::enable_if<aether_boost::is_void<SlotResultType> >::type * = 0) const
          {
          ...
          template<typename SlotResultType>
          result_type m_invoke(const connection_body_type &connectionBody, 
            typename aether_boost::disable_if<aether_boost::is_void<SlotResultType> >::type * = 0) const
          {
    ...
    namespace detail
    {
      ...
      public:
        ...
        result_type operator ()(BOOST_SIGNALS2_SIGNATURE_FULL_ARGS(BOOST_SIGNALS2_NUM_ARGS))
        {
          ...
          if(shared_pimpl == 0) aether_boost::throw_exception(expired_slot());
      ...
      private:
        aether_boost::weak_ptr<detail::BOOST_SIGNALS2_SIGNAL_IMPL_CLASS_NAME(BOOST_SIGNALS2_NUM_ARGS)
...
// const aether_boost::signals2::connection &,
...
#define BOOST_SIGNALS2_EXT_SIGNATURE(arity, Signature) \
  typename function_traits<Signature>::result_type ( \
  const aether_boost::signals2::connection & BOOST_SIGNALS2_PP_COMMA_IF(BOOST_SIGNALS2_NUM_ARGS) \
