...
// and predestructors through the aether_boost::signals2::postconstructible and
// aether_boost::signals2::predestructible base classes.
//
...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost
{
  namespace signals2
  {
    ...
    shared_ptr<T> deconstruct_ptr(T *ptr)
    {
      ...
      shared_ptr<T> shared(ptr, aether_boost::signals2::predestructing_deleter<T>());
