...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost
{
  namespace signals2
  {
    namespace detail
    {
      ...
      typedef aether_boost::variant<aether_boost::weak_ptr<trackable_pointee>, aether_boost::weak_ptr<void>, detail::foreign_void_weak_ptr > void_weak_ptr_variant;
      typedef aether_boost::variant<aether_boost::shared_ptr<void>, detail::foreign_void_shared_ptr > void_shared_ptr_variant;
      ...
      public:
        ...
        {
          return aether_boost::shared_ptr<void>();
        }
      };
