...
#define BOOST_SIGNALS2_SLOT_N_BINDING_CONSTRUCTOR(z, n, data) \
  ...
  { \
    init_slot_function(aether_boost::bind(func, BOOST_SIGNALS2_SIGNATURE_ARG_NAMES(n))); \
  }
...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost
{
  namespace signals2
  {
    ...
    {
    private:
      typedef typename detail::slotN<aether_boost::function_traits<Signature>::arity,
