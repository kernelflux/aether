...
// The objects must inherit from aether_boost::signals2::postconstructible, and
// have their lifetimes managed by
// aether_boost::shared_ptr created with the aether_boost::signals2::deconstruct_ptr()
// function.
//
...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost
{
  ...
  namespace signals2
  {
    ...
    namespace detail
    {
      void do_postconstruct(const aether_boost::signals2::postconstructible_adl_barrier::postconstructible *ptr);
    } // namespace detail
