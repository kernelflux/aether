...
{
    typedef aether_boost::detail::atomic_count type;

    static unsigned int load(aether_boost::detail::atomic_count const& counter) BOOST_NOEXCEPT
    {
        return static_cast< unsigned int >(static_cast< long >(counter));
    }

    static void increment(aether_boost::detail::atomic_count& counter) BOOST_NOEXCEPT
    {
        ++counter;
    }

    static unsigned int decrement(aether_boost::detail::atomic_count& counter) BOOST_NOEXCEPT
    {
        return --counter;
    }
};
