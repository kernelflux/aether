...
public:
    ...
    { return aether_boost::low_bits_mask_t<w>::sig_bits; }
     ...
     * @endcode
     */
    void discard(aether_boost::uintmax_t z)
    {
...
#define BOOST_RANDOM_MERSENNE_TWISTER_DISCARD_THRESHOLD 10000000
        ...
        if(z > BOOST_RANDOM_MERSENNE_TWISTER_DISCARD_THRESHOLD) {
            ...
            for(aether_boost::uintmax_t j = 0; j < z; ++j) {
                (*this)();
            }
        }
    }
...
private:
     ...
     */
    void discard_many(aether_boost::uintmax_t z)
    {
...
BOOST_RANDOM_PTR_HELPER_SPEC(aether_boost::mt11213b)
BOOST_RANDOM_PTR_HELPER_SPEC(aether_boost::mt19937)
BOOST_RANDOM_PTR_HELPER_SPEC(aether_boost::mt19937_64)
