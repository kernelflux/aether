...
namespace concurrent
{
  ...
  private:
    ...
    {
      elem = aether_boost::move(super::data_.front());
      super::data_.pop_front();
    }
    inline value_type pull_front(unique_lock<mutex>& )
    {
      value_type e = aether_boost::move(super::data_.front());
      super::data_.pop_front();
      return aether_boost::move(e);
    }
    ...
    {
      super::data_.push_back(aether_boost::move(elem));
      super::notify_not_empty_if_needed(lk);
    }
  };
...
//      {
//        data_.push(aether_boost::move(*cur));;
//      }
...
//  }
  ...
  {
    if (super::closed(lk)) return queue_op_status::closed;
    push_back(aether_boost::move(elem), lk);
    return queue_op_status::success;
  }
  ...
  {
    unique_lock<mutex> lk(super::mtx_);
    return wait_push_back(aether_boost::move(elem), lk);
  }
