...
namespace detail {
  ...
  public:
      ...
      {
          _elements.push_back(aether_boost::move(element));
          std::push_heap(_elements.begin(), _elements.end(), _compare);
      }
      ...
      Type pull()
      {
          Type result = aether_boost::move(_elements.front());
          pop();
          return aether_boost::move(result);
      }
...
namespace concurrent
{
  ...
  class sync_priority_queue
    : public detail::sync_queue_base<ValueType, aether_boost::detail::priority_queue<ValueType,Container,Compare> >
  {
    typedef detail::sync_queue_base<ValueType, aether_boost::detail::priority_queue<ValueType,Container,Compare> >  super;
  ...
  {
    super::throw_if_closed(lk);
    super::data_.push(aether_boost::move(elem));
    super::notify_not_empty_if_needed(lk);
  }
  template <class T, class Container,class Cmp>
  ...
  {
    lock_guard<mutex> lk(super::mtx_);
    push(lk, aether_boost::move(elem));
  }
