            ...
            if(detail::enter_once_region(flag, ctx))
            {
                BOOST_TRY
                {
                  BOOST_THREAD_INVOKE_RET_VOID(
                        ...
                        thread_detail::decay_copy(aether_boost::forward<A>(a)),
                  ...
                  !=ctx.function_complete_flag_value)
            {
                if(detail::enter_once_region(flag, ctx))
                {
                    BOOST_TRY
                    {
                      f(
                          thread_detail::decay_copy(aether_boost::forward<T1>(p1)),
                          thread_detail::decay_copy(aether_boost::forward<T2>(p2))
                      );
                    }
                    BOOST_CATCH(...)
                    {
                ...
                if(detail::enter_once_region(flag, ctx))
                {
                    BOOST_TRY
                    {
                      f(
                          thread_detail::decay_copy(aether_boost::forward<T1>(p1)),
                          thread_detail::decay_copy(aether_boost::forward<T2>(p2)),
                          thread_detail::decay_copy(aether_boost::forward<T3>(p3))
                      );
                    }
                    BOOST_CATCH(...)
                    {
