...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost
{
  ...
  protected:
    ...
    aether_boost::unique_lock<mutex_type> lk_;
    T const& value_;
  ...
  public:
    ...
    : lk_(aether_boost::move(BOOST_THREAD_RV(other).lk_)),value_(BOOST_THREAD_RV(other).value_)
    {
    }
  ...
  public:
    ...
    : base_type(aether_boost::move(static_cast<base_type&>(other)))
    {
    }
  ...
  public:
    ...
    : base_type(aether_boost::move(static_cast<base_type&>(other))), value_(BOOST_THREAD_RV(other).value_)
    {
    }
  ...
  public:
    ...
    : value_(aether_boost::move(other))
    {
    }
    ...
    synchronized_value(BOOST_THREAD_RV_REF(synchronized_value) other)
    {
      ...
      value_= aether_boost::move(BOOST_THREAD_RV(other).value_);
    }
    ...
    void swap(synchronized_value & rhs)
    {
      ...
      unique_lock<mutex_type> lk2(rhs.mtx_, defer_lock);
      lock(lk1,lk2);
      aether_boost::swap(value_, rhs.value_);
    }
    /**
    ...
    template <typename F>
    inline
    typename aether_boost::result_of<F(value_type&)>::type
    ...
    template <typename F>
    inline
    typename aether_boost::result_of<F(value_type const&)>::type
...
//  struct hash<synchronized_value<T,L> >;
  ...
  synchronize(SV1& sv1, SV2& sv2)
  {
    aether_boost::lock(sv1.mtx_, sv2.mtx_);
    typedef std::tuple<
        typename synchronized_value_strict_lock_ptr<SV1>::type,
        typename synchronized_value_strict_lock_ptr<SV2>::type
        > t_type;
