...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost
{
  namespace detail
  {
    ...
    public:
      ...
      : f_(aether_boost::forward<F>(f), aether_boost::forward<As>(args)...)
      {}

      BOOST_SYMBOL_VISIBLE
      invoker(BOOST_THREAD_RV_REF(invoker) f) : f_(aether_boost::move(BOOST_THREAD_RV(f).f_))
      {}
      ...
      invoker& operator=(BOOST_THREAD_RV_REF(invoker) f)
      {
        if (this != &f)
        {
          f_ = aether_boost::move(BOOST_THREAD_RV(f).f_);
        }
        return *this;
      }
    ...
    private:
      ...
      {
        return detail::invoke(aether_boost::move(csbl::get<0>(f_)), aether_boost::move(csbl::get<Indices>(f_))...);
      }
    };
    ...
    public:
      ...
      BOOST_SYMBOL_VISIBLE
      invoker_ret(BOOST_THREAD_RV_REF(invoker_ret) f) : f_(aether_boost::move(BOOST_THREAD_RV(f).f_))
      {}
    ...
    private:
      ...
      execute(tuple_indices<Indices...>)
      {
        return detail::invoke<R>(aether_boost::move(csbl::get<0>(f_)), aether_boost::move(csbl::get<Indices>(f_))...);
      }
    };
...
#define BOOST_THREAD_FWD_PARAM(z, n, unused) , aether_boost::forward<Arg##n>(arg##n)
#define BOOST_THREAD_FWD_PARAM_A(z, n, unused) , aether_boost::forward<A##n>(arg##n)
#define BOOST_THREAD_DCL(z, n, unused) Arg##n v##n;
#define BOOST_THREAD_MOVE_PARAM(z, n, unused) , v##n(aether_boost::move(arg##n))
#define BOOST_THREAD_FORWARD_PARAM_A(z, n, unused) , v##n(aether_boost::forward<A##n>(arg##n))
#define BOOST_THREAD_MOVE_RHS_PARAM(z, n, unused) , v##n(aether_boost::move(x.v##n))
#define BOOST_THREAD_MOVE_DCL(z, n, unused) , aether_boost::move(v##n)
#define BOOST_THREAD_MOVE_DCL_T(z, n, unused) BOOST_PP_COMMA_IF(n) aether_boost::move(v##n)
...
#define BOOST_THREAD_ASYNC_FUNCT(z, n, unused) \
    ...
    public:
      ...
      : fp_(aether_boost::move(f))
      , v0_(aether_boost::move(a0))
      , v1_(aether_boost::move(a1))
      , v2_(aether_boost::move(a2))
      , v3_(aether_boost::move(a3))
      , v4_(aether_boost::move(a4))
      , v5_(aether_boost::move(a5))
      , v6_(aether_boost::move(a6))
      , v7_(aether_boost::move(a7))
      , v8_(aether_boost::move(a8))
      {}

      BOOST_SYMBOL_VISIBLE
      invoker(BOOST_THREAD_RV_REF(invoker) f)
      : fp_(aether_boost::move(BOOST_THREAD_RV(f).fp))
      , v0_(aether_boost::move(BOOST_THREAD_RV(f).v0_))
      , v1_(aether_boost::move(BOOST_THREAD_RV(f).v1_))
      , v2_(aether_boost::move(BOOST_THREAD_RV(f).v2_))
      , v3_(aether_boost::move(BOOST_THREAD_RV(f).v3_))
      , v4_(aether_boost::move(BOOST_THREAD_RV(f).v4_))
      , v5_(aether_boost::move(BOOST_THREAD_RV(f).v5_))
      , v6_(aether_boost::move(BOOST_THREAD_RV(f).v6_))
      , v7_(aether_boost::move(BOOST_THREAD_RV(f).v7_))
      , v8_(aether_boost::move(BOOST_THREAD_RV(f).v8_))
      {}

      result_type operator()()
      {
        return detail::invoke(aether_boost::move(fp_)
            , aether_boost::move(v0_)
            , aether_boost::move(v1_)
            , aether_boost::move(v2_)
            , aether_boost::move(v3_)
            , aether_boost::move(v4_)
            , aether_boost::move(v5_)
            , aether_boost::move(v6_)
            , aether_boost::move(v7_)
            , aether_boost::move(v8_)
        );
      }
    };
