...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost
{
  ...
  typename aether_boost::disable_if<is_future_type<Iterator>,void>::type wait_for_all(Iterator begin,Iterator end)
  {
    ...
    typename aether_boost::enable_if<is_future_type<F1>,void>::type wait_for_all(F1& f1,F2& f2)
    {
        f1.wait();
        f2.wait();
    }
