  ...
  namespace posix {
    ...
    public:
        ...
        mutex()
        {
            ...
            if(res)
            {
                aether_boost::throw_exception(thread_resource_error(res, "boost:: mutex constructor failed in pthread_mutex_init"));
            }
        }
        ~mutex()
        {
          int const res = posix::pthread_mutex_destroy(&m);
          aether_boost::ignore_unused(res);
          BOOST_ASSERT(!res);
        }
        ...
        void lock()
        {
            ...
            if (res)
            {
                aether_boost::throw_exception(lock_error(res,"boost: mutex lock failed in pthread_mutex_lock"));
            }
        }
...
//            if (res)
//            {
//                aether_boost::throw_exception(lock_error(res,"boost: mutex unlock failed in pthread_mutex_unlock"));
//            }
        }
...
#define BOOST_THREAD_DEFINES_MUTEX_NATIVE_HANDLE
    ...
    public:
        ...
        timed_mutex()
        {
            ...
            if(res)
            {
                aether_boost::throw_exception(thread_resource_error(res, "boost:: timed_mutex constructor failed in pthread_mutex_init"));
            }
#ifndef BOOST_PTHREAD_HAS_TIMEDLOCK
            ...
            if(res2)
            {
                ...
                aether_boost::throw_exception(thread_resource_error(res2, "boost:: timed_mutex constructor failed in pthread_cond_init"));
            }
            is_locked=false;
#endif
        }
        ...
        bool timed_lock(aether_boost::xtime const & absolute_time)
        {
