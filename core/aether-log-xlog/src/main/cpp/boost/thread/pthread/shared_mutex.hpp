...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost
{
    ...
    private:
        ...
        state_data state;
        aether_boost::mutex state_change;
        aether_boost::condition_variable shared_cond;
        aether_boost::condition_variable exclusive_cond;
        aether_boost::condition_variable upgrade_cond;
    ...
    public:
        ...
        {
#if defined BOOST_THREAD_PROVIDES_INTERRUPTIONS
            aether_boost::this_thread::disable_interruption do_not_disturb;
#endif
            aether_boost::unique_lock<boost::mutex> lk(state_change);
