...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost
{
  namespace executors
  {
    ...
    resubmit(Executor& ex, BOOST_THREAD_FWD_REF(Function) funct) {
      return resubmitter<Executor, typename decay<Function>::type >(ex, aether_boost::move(funct));
    }
    ...
    public:
      ...
      void submit(BOOST_THREAD_FWD_REF(Work) w)
      {
        ...
        sch.submit_at(resubmit(ex,aether_boost::forward<Work>(w)), tp);
      }
    ...
    public:
      ...
      void submit(BOOST_THREAD_FWD_REF(Work) w)
      {
        ...
        sch.submit_at(aether_boost::forward<Work>(w), tp);
      }
