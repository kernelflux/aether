...
namespace executors
{
  ...
  public:
    ...
    executor_adaptor(BOOST_THREAD_RV_REF(Args) ... args) : ex(aether_boost::forward<Args>(args)...) {}
#else
    /**
     * executor_adaptor constructor
     */
    ...
    void submit(BOOST_THREAD_RV_REF(work) closure)  {
      return ex.submit(aether_boost::move(closure));
    }
    ...
    {
      //submit(work(aether_boost::forward<Closure>(closure)));
      work w((aether_boost::forward<Closure>(closure)));
      submit(aether_boost::move(w));
    }
