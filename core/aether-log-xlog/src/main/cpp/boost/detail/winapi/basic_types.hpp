...
// MinGW64 gcc 4.8.2 fails to compile function declarations with aether_boost::detail::winapi::VOID_ arguments even though
...
typedef aether_boost::int64_t LONGLONG_;
typedef aether_boost::uint64_t ULONGLONG_;
