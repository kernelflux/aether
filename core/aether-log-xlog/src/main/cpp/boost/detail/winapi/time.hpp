...
BOOST_SYMBOL_IMPORT aether_boost::detail::winapi::VOID_ WINAPI
...
BOOST_SYMBOL_IMPORT aether_boost::detail::winapi::ULONGLONG_ WINAPI
...
{
    aether_boost::detail::winapi::SYSTEMTIME_ st;
    aether_boost::detail::winapi::GetSystemTime(&st);
    aether_boost::detail::winapi::SystemTimeToFileTime(&st, lpFileTime);
}
#endif
