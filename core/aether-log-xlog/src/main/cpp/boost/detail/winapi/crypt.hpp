...
namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost { namespace detail { namespace winapi {
...
BOOST_SYMBOL_IMPORT aether_boost::detail::winapi::BOOL_ WINAPI
CryptEnumProvidersA(
    aether_boost::detail::winapi::DWORD_ dwIndex,
    aether_boost::detail::winapi::DWORD_ *pdwReserved,
    aether_boost::detail::winapi::DWORD_ dwFlags,
    aether_boost::detail::winapi::DWORD_ *pdwProvType,
    aether_boost::detail::winapi::LPSTR_ szProvName,
    aether_boost::detail::winapi::DWORD_ *pcbProvName);
#else
...
CryptEnumProvidersA(
    ...
    aether_boost::detail::winapi::DWORD_ dwFlags,
    aether_boost::detail::winapi::DWORD_ *pdwProvType,
    aether_boost::detail::winapi::LPWSTR_ szProvName,
    aether_boost::detail::winapi::DWORD_ *pcbProvName);
#endif

BOOST_SYMBOL_IMPORT aether_boost::detail::winapi::BOOL_ WINAPI
CryptAcquireContextA(
    aether_boost::detail::winapi::HCRYPTPROV_ *phProv,
    aether_boost::detail::winapi::LPCSTR_ pszContainer,
    aether_boost::detail::winapi::LPCSTR_ pszProvider,
    aether_boost::detail::winapi::DWORD_ dwProvType,
    aether_boost::detail::winapi::DWORD_ dwFlags);
...
CryptAcquireContextW(
    aether_boost::detail::winapi::HCRYPTPROV_ *phProv,
    aether_boost::detail::winapi::LPCWSTR_ szContainer,
    aether_boost::detail::winapi::LPCWSTR_ szProvider,
    aether_boost::detail::winapi::DWORD_ dwProvType,
    aether_boost::detail::winapi::DWORD_ dwFlags);

BOOST_SYMBOL_IMPORT aether_boost::detail::winapi::BOOL_ WINAPI
CryptGenRandom(
    aether_boost::detail::winapi::HCRYPTPROV_ hProv,
    aether_boost::detail::winapi::DWORD_ dwLen,
    aether_boost::detail::winapi::BYTE_ *pbBuffer);
