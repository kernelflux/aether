...
#define BOOST_TYPEOF_REGISTER_TEMPLATE_IMPL(Name, Params, Size, ID)\
    ...
    {\
        typedef typename aether_boost::type_of::push_back<V, aether_boost::mpl::size_t<ID> >::type V0;\
    ...
    {\
        typedef decode_type_impl<aether_boost::mpl::size_t<ID>, Iter> self_t;\
        typedef aether_boost::mpl::size_t<ID> self_id;\
        typedef Iter iter0;\
