...
#   define BOOST_TYPEOF_BEGIN_ENCODE_NS namespace { namespace aether_boost_typeof {
#   define BOOST_TYPEOF_END_ENCODE_NS }}
#   define BOOST_TYPEOF_ENCODE_NS_QUALIFIER aether_boost_typeof

#else

#   define BOOST_TYPEOF_BEGIN_ENCODE_NS namespace aether_boost {} namespace boost = aether_boost; namespace aether_boost { namespace type_of {
#   define BOOST_TYPEOF_END_ENCODE_NS }}
#   define BOOST_TYPEOF_ENCODE_NS_QUALIFIER aether_boost::type_of
